            ...
            <div class="container">
                <a href="{{ route('home') }}" class="navbar-brand mb-0 h1"><i
                    ...
                    <div class="collapse navbar-collapse"id="navbarSupportedContent">
                        ...
                        <a href="{{ route('profile') }}" class="btn btn-outline-light my-2 ms-md-auto"><i class="bi-person-circle me-1"></i>Profile</a>
            ...
            <div class="container mt-4">
                ...
                <div class="col-lg-3 col-xl-2">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('employees.create') }}" class="btn btn-primary">Create Customers</a>
